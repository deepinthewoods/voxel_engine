...
public class SlideColorPicker extends Slider
{
    ...
    private com.badlogic.gdx.graphics.Color retCol = new com.badlogic.gdx.graphics.Color();
    private Color intCol = new Color(0);
    public com.badlogic.gdx.graphics.Color getSelectedColor(){
        int i = (int)((getValue()/360f)*pixMap.getWidth());
        Gdx.app.log("color slider ", "color"+pixMap.getPixel(i, 2));
        retCol.set(pixMap.getPixel(i, 0));
        //retCol.set(ColorUtil.HSBtoRGB(getValue()/360f, getSaturation(), getBrightness()));
        return retCol;
    }
