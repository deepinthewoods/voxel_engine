 ...
 * @author Nathan Sweet */
public class JsonReflect extends Json{
	...
	public JsonReflect (OutputType outputType) {
	...
	static public interface Serializer<T> {
		public void write (JsonReflect json, T object, Class knownType);

		public T read (JsonReflect json, JsonValue jsonData, Class type);
	}
	...
	static abstract public class ReadOnlySerializer<T> implements Serializer<T> {
		...
		abstract public T read (JsonReflect json, JsonValue jsonData, Class type);
	}

	static public interface Serializable {
		public void write (JsonReflect json);

		public void read (JsonReflect json, JsonValue jsonData);
	}
}
